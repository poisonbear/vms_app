              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.white,
                      padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 10), // 패딩 수정
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(6),
                        side: const BorderSide(color: Color(0xFF5CA1F6), width: 1),
                      ),
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const Text("실시간 위치", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const Text("현재 위치", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                      const SizedBox(height: 16),
                      Text("위도: ${position.latitude}"),
                      Text("경도: ${position.longitude}"),
                      const SizedBox(height: 20),
                          ...
                          children: [
                            ...
                            CircularButton(
                              ...
                              onTap: () {
                                ...
                                _mapControllerProvider.mapController.moveAndRotate(const LatLng(35.374509, 126.132268), 12.0, 0.0); // 지도를 기본 위치와 줌 레벨로 이동
