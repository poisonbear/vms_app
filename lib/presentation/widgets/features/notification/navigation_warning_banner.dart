      ...
      builder: (context, navProvider, child) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            color: hasWarning ? const Color(0xFFD32F2F) : const Color(0xFFE57373),
            // 상단에 그림자
            boxShadow: [
              BoxShadow(
          ...
          child: Row(
            children: [
              ...
              if (hasWarning)
                const Padding(
                  padding: EdgeInsets.only(left: AppSizes.s12, right: AppSizes.s8),
                  child: Icon(
              ...
              // 오른쪽 여백 (아이콘과 균형)
              if (hasWarning)
                const SizedBox(width: AppSizes.s44),
            ],
          ),
        );
      },
