...
import 'package:vms_app/presentation/providers/terms/privacy_policy_provider.dart';
import 'package:vms_app/presentation/providers/terms/service_terms_provider.dart';
import 'package:vms_app/presentation/screens/auth/register_screen.dart';
import 'package:vms_app/presentation/screens/auth/terms/location_terms_screen.dart';
import 'package:vms_app/presentation/screens/auth/terms/marketing_terms_screen.dart';
import 'package:vms_app/presentation/screens/auth/terms/privacy_policy_screen.dart';
import 'package:vms_app/presentation/screens/auth/terms/service_terms_screen.dart';
...
class CmdChoiceView extends StatefulWidget {
  // 상태관리를 위해 선언
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        FutureProvider(
          create: (_) async {
            final viewModel = ServiceTermsProvider();
            await viewModel.getCmdList();
            return viewModel;
          },
          initialData: ServiceTermsProvider(),
        ),
        FutureProvider(
          create: (_) async {
            final viewModel = PrivacyPolicyProvider();
            await viewModel.getCmdList();
            return viewModel;
          },
          initialData: PrivacyPolicyProvider(),
        ),
        FutureProvider(
          create: (_) async {
            final viewModel = LocationTermsProvider();
            await viewModel.getCmdList();
            return viewModel;
          },
          initialData: LocationTermsProvider(),
        ),
        FutureProvider(
          create: (_) async {
            final viewModel = MarketingTermsProvider();
            await viewModel.getCmdList();
            return viewModel;
          },
          initialData: MarketingTermsProvider(),
        ),
      ],
      builder: (context, child) {
        final serviceVM = Provider.of<ServiceTermsProvider>(context);
        final infoVM = Provider.of<PrivacyPolicyProvider>(context);
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    children: [
                      const Spacer(),
                      svgload('assets/kdn/usm/img/Frame_one_on.svg', getSize32().toDouble(),
                          getSize32().toDouble()),
                      svgload('assets/kdn/usm/img/Frame_two_off.svg', getSize32().toDouble(),
                          getSize32().toDouble()),
                      svgload('assets/kdn/usm/img/Frame_three_off.svg', getSize32().toDouble(),
                          getSize32().toDouble()),
                    ],
                  ),
                ),
                ...
                Padding(
                  padding:
                      EdgeInsets.only(top: getSize12().toDouble(), bottom: getSize60().toDouble()),
                ...
                if (!allDataLoaded)
                  ...
                  Padding(
                    ...
                    child: _buildAgreementRow_Service(
                      context,
                      TextWidgetString('${serviceVM.cmdList![0].terms_nm}', getTextcenter(),
                          getSize16(), getText700(), getColorblack_type2()),
                      _serviceAgreement,
                      (value) {
                        setState(() {
                      ...
                      viewModel: ServiceTermsProvider(),
                      page: () => const CmdServiceView(),
                      choicestring: TextWidgetString(
                          '필수', getTextcenter(), getSize10(), getText700(), getColorsky_Type2()),
                    ),
                  ),
                  Padding(
                    padding:
                        EdgeInsets.only(top: getSize20().toDouble(), left: getSize20().toDouble()),
                    child: _buildAgreementRow_Service(
                      context,
                      TextWidgetString('${infoVM.cmdList![0].terms_nm}', getTextcenter(),
                          getSize16(), getText700(), getColorblack_type2()),
                      _privacyAgreement,
                      (value) {
                        setState(() {
                      ...
                      viewModel: PrivacyPolicyProvider(),
                  ...
                  Padding(
                    ...
                    child: _buildAgreementRow_Service(
                      context,
                      TextWidgetString('${locationVM.cmdList![0].terms_nm}', getTextcenter(),
                          getSize16(), getText700(), getColorblack_type2()),
                      _locationAgreement,
                      (value) {
                        setState(() {
                      ...
                      viewModel: LocationTermsProvider(),
                  ...
                  Padding(
                    ...
                    child: _buildAgreementRow_Service(
                      context,
                      TextWidgetString('${marketVM.cmdList![0].terms_nm}', getTextcenter(),
                          getSize16(), getText700(), getColorblack_type2()),
                      _marketAgreement,
                      (value) {
                        setState(() {
                      ...
                      viewModel: MarketingTermsProvider(),
                      page: () => const CmdMarkettingview(),
                      choicestring: TextWidgetString(
                          '선택', getTextcenter(), getSize10(), getText700(), getColorgray_Type6()),
                    ),
                  ),
                ],
                ...
                Center(
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: TextWidgetString('약관에 동의하고 계속하기', getTextcenter(), getSize16(),
...
//이용약관 레이어
Widget _buildAgreementRow_Service<T extends ChangeNotifier>(
    BuildContext context, Widget title, bool value, ValueChanged<bool?> onChanged,
    {required T viewModel, required Widget Function() page, required Widget choicestring}) {
