                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: TextWidgetString(
                                'K-VMS', getTextcenter(), getSize32(), getTextbold(), getColorblack_type1()),
                          ),
                            ...
                            child: BackdropFilter(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    TextWidgetString(
                                        '시스템 로그인', getTextcenter(), getSize24(), getTextbold(), getColorblack_type1()),
                                    Padding(
                                      padding: const EdgeInsets.only(bottom: 20),
                                      child: TextWidgetString('시스템 사용을 위해 로그인을 해주시기 바랍니다.', getTextcenter(),
                                          getSize12(), getTextbold(), getColorgray_Type1()),
                                    ),
                                    // 아이디 입력
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: inputWidget(
                                            getSize266(), getSize48(), idController, '아이디 입력', getColorgray_Type7()),
                                      ),
                                    ),
                                    // 비밀번호 입력
                                    Padding(
