...
class _MainViewNavigationSheetState extends State<MainViewNavigationSheet> {
  ...
  Widget build(BuildContext context) {
    final routeSearchViewModel = Provider.of<RouteSearchProvider>(context, listen: false); // RouteSearchProvider 가져오기
    return WillPopScope(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          TextWidgetString(
                              '항행 이력 내역 조회', getTextleft(), getSize20(), getText700(), getColorblack_type2()),
                          const Spacer(),
                          Container(
                            child: SizedBox(
                              width: 24,
                            ...
                            child: SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    TextWidgetString(selectedStartDate, getTextleft(), getSize14(), getText600(),
                                        getColorgray_Type8()),
                            ...
                            child: SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    TextWidgetString(selectedEndDate, getTextleft(), getSize14(), getText600(),
                                        getColorgray_Type8()),
                                    Icon(Icons.calendar_today, size: 20, color: getColorgray_Type8()),
                                  ],
                                ),
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  contentPadding: EdgeInsets.symmetric(
                                      horizontal: getSize12().toDouble(), vertical: getSize12().toDouble()),
                                  isDense: true,
                              ...
                              child: provider.isLoading
                                  ...
                                  : Row(
                                      ...
                                      children: [
                                        ...
                                        TextWidgetString('항행 이력 내역 조회하기', getTextcenter(), getSize14(), getText600(),
                                            getColorsky_Type1()),
                                      ],
                                    ),
                            );
                              ...
                              return Expanded(
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: Center(
                                    child: Container(
                                      width: double.infinity,
                                      margin: EdgeInsets.only(top: getSize60().toDouble()),
                                      // ✅ SizedBox 대신 여백
                              ...
                              child: Column(
                                children: [
                                  for (int i = 0; i < rosList.length; i++) ...[
                                    _buildNavigationItem(context, '${rosList[i].mmsi}', '${rosList[i].shipName}',
                                        '${rosList[i].odb_reg_date}', routeSearchViewModel),
                                  ],
                                ],
                              ),
                            );
...
// 항행 이력 아이템 위젯
  Widget _buildNavigationItem(
      BuildContext context, String mmsi, String shipNm, String startTime, RouteSearchProvider viewModel) {
          ...
          onTap: () async {
            ...
            try {
              ...
              if (viewModel.pastRoutes.isNotEmpty) {
                LatLng firstPoint =
                    LatLng(viewModel.pastRoutes.last.lttd ?? 35.3790988, viewModel.pastRoutes.last.lntd ?? 126.167763);
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            TextWidgetString(
                                formattedTime, getTextleft(), getSize12(), getText600(), getColorgray_Type3()),
                          ],
                        ),
                      ],
                    ),
  ...
  Widget _buildCollapsedBottomSheet(
      BuildContext context, String shipName, String mmsi, String formattedTime, RouteSearchProvider viewModel) {
