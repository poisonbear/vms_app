      ...
      children: List.generate(labels.length, (index) {
        return Padding(
          padding: paddings[index].copyWith(
            top: paddings[index].top.toDouble() * getSize1(),
            bottom: paddings[index].bottom.toDouble() * getSize1(),
            left: paddings[index].left.toDouble() * getSize1(),
            right: paddings[index].right.toDouble() * getSize1(),
          ),
