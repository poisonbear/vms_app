            ...
            children: [
              Padding(
                ...
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    TextWidgetString('아이디', getTextcenter(), getSize16(), getText700(), getColorGrayType8()),
                  ],
                ),
              ),
              SizedBox(
                ...
                child: Padding(
                  ...
                  child: inputWidget_deactivate(getSize266(), getSize48(), idController, '', getColorGrayType7(),
                      isReadOnly: true),
                ),
              ),
              Padding(
                ...
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    TextWidgetString('기존 비밀번호', getTextcenter(), getSize16(), getText700(), getColorGrayType8()),
                  ],
                ),
              ),
              SizedBox(
                ...
                child: Padding(
                  ...
                  child: inputWidget(getSize266(), getSize48(), passwordController, '비밀번호', getColorGrayType7(),
                      obscureText: true),
                ),
              ),
                  ...
                  child: Column(
                    ...
                    children: [
                      TextWidgetString('비밀번호는 문자, 숫자 및 특수문자를 포함한 6자리 이상 12자리 이하로 입력하여야 합니다.', getTextleft(),
                          getSize12(), getText700(), getColorRedType3()),
                    ],
                  ),
                ),
              Padding(
                ...
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    TextWidgetString('새로운 비밀번호', getTextcenter(), getSize16(), getText700(), getColorGrayType8()),
                  ],
                ),
              ),
              SizedBox(
                ...
                child: Padding(
                  padding: EdgeInsets.only(bottom: getSize20().toDouble()),
                  child: inputWidget(getSize266(), getSize48(), newPasswordController, '비밀번호', getColorGrayType7(),
                      obscureText: true),
                ),
              ),
              Padding(
                ...
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    TextWidgetString('새로운 비밀번호 확인', getTextcenter(), getSize16(), getText700(), getColorGrayType8()),
                  ],
                ),
              ),
              SizedBox(
                ...
                child: Padding(
                  padding: EdgeInsets.only(bottom: getSize20().toDouble()),
                  child: inputWidget(
                      getSize266(), getSize48(), confirmPasswordController, '비밀번호 확인', getColorGrayType7(),
                      obscureText: true),
                ),
              ),
              Padding(
                padding: EdgeInsets.only(bottom: getSize8().toDouble()),
                child: TextWidgetString('선박 MMSI 번호', getTextcenter(), getSize16(), getText700(), getColorGrayType8()),
              ),
              SizedBox(
                width: double.infinity,
                child: Padding(
                  padding: EdgeInsets.only(bottom: getSize20().toDouble()),
                  child: inputWidget(
                      getSize266(), getSize48(), mmsiController, 'MMSI 번호(숫자 9자리)를 입력해주세요', getColorGrayType7()),
                ),
              ),
              Padding(
                padding: EdgeInsets.only(bottom: getSize8().toDouble()),
                child: TextWidgetString('휴대폰 번호', getTextcenter(), getSize16(), getText700(), getColorGrayType8()),
              ),
              SizedBox(
                width: double.infinity,
                child: Padding(
                  padding: EdgeInsets.only(bottom: getSize20().toDouble()),
                  child:
                      inputWidget(getSize266(), getSize48(), phoneController, "'-' 구분없이 숫자만 입력", getColorGrayType7()),
                ),
              ),
              Padding(
                padding: EdgeInsets.only(bottom: getSize8().toDouble()),
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    TextWidgetString('이메일', getTextcenter(), getSize16(), getText700(), getColorGrayType8()),
                  ],
                ),
              ),
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextWidgetString('@', getTextcenter(), getSize16(), getText700(), getColorGrayType8()),
                    ),
                    Expanded(
                      child: Stack(
