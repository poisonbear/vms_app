...
class ValidationPatterns {
  ...
  /// 전화번호 유효성 검증 (형식 포함)
  static bool isValidPhoneFormat(String phone) => phoneFormatRegExp.hasMatch(phone);
  ...
  static bool hasSpecialChar(String password) => specialCharRegExp.hasMatch(password);
  ...
  static bool isValidPassword(String password) {
    ...
    return hasLetter(password) && hasNumber(password) && hasSpecialChar(password);
  }

  /// 상세한 비밀번호 검증 결과
  static Map<String, bool> validatePasswordDetails(String password) {
    return {
      'hasValidLength': password.length >= ValidationConstants.passwordMinLength &&
          password.length <= ValidationConstants.passwordMaxLength,
...
class ValidationHelper {
  ...
  static Map<String, bool> validateIdDetailed(String id) {
    return {
      'hasValidLength': id.length >= ValidationConstants.idMinLength && id.length <= ValidationConstants.idMaxLength,
  ...
  static bool validateIfNotEmpty(String value, bool Function(String) validator) {
