...
Color getColorblack_type3() {
  return const Color(0x00000000);
}

Color getColorblack_type4() {
  return const Color(0x99000000);
}

//회색
Color getColorgray_Type1() {
...
Color getColorgray_Type5() {
  return const Color(0xFFEDEDED);
}

Color getColorgray_Type6() {
